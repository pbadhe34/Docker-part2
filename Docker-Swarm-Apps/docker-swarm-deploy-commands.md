...
Run your load-balanced app with swarm network cluster
...
To add a worker to this swarm, run the following command:
     ...
     docker swarm join --token SWMTKN-1-65qo2iwkpz4b47o87edxyhw6esapc4b8ypugph4e8vhg8s1k4j-6cxa1hn7hsp9xa4foomxyhdvf 192.168.0.6:2377


 Add one more manager to this swarm, run 'docker swarm join-token manager' and follow he instructions.
 

echo "MyDBPass#" | docker secret create db_pass -
...
docker stack deploy -c docker-compose-java-mysql-secret app1

 OR

  docker-compose -f docker-compose-py-redis-app.yml  up
